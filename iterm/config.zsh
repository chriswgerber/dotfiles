...
export ITERM2_UTIL_DIR="$HOME/.iterm2";
...
alias imgcat=${ITERM2_UTIL_DIR}/imgcat
alias imgls=${ITERM2_UTIL_DIR}/imgls
alias it2api=${ITERM2_UTIL_DIR}/it2api
alias it2attention=${ITERM2_UTIL_DIR}/it2attention
alias it2cat=${ITERM2_UTIL_DIR}/it2cat
alias it2check=${ITERM2_UTIL_DIR}/it2check
alias it2copy=${ITERM2_UTIL_DIR}/it2copy
alias it2dl=${ITERM2_UTIL_DIR}/it2dl
alias it2getvar=${ITERM2_UTIL_DIR}/it2getvar
alias it2git=${ITERM2_UTIL_DIR}/it2git
alias it2profile=${ITERM2_UTIL_DIR}/it2profile
alias it2setcolor=${ITERM2_UTIL_DIR}/it2setcolor
alias it2setkeylabel=${ITERM2_UTIL_DIR}/it2setkeylabel
alias it2ssh=${ITERM2_UTIL_DIR}/it2ssh
alias it2tip=${ITERM2_UTIL_DIR}/it2tip
alias it2ul=${ITERM2_UTIL_DIR}/it2ul
alias it2universion=${ITERM2_UTIL_DIR}/it2universion
